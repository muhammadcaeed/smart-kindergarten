...
@Component({
  selector: 'page-edit-teacher-profile',
  templateUrl: 'edit-teacher-profile.html',
...
export class EditTeacherProfilePage {
  ...
  constructor(
    ...
    console.log('this.navParams.get : ', this.navParams.get('id'));

    this.userService.getTeacherById(this.navParams.get('id'))
      .subscribe( result => {
