...
export class CustomHttp extends Http {
    constructor(backend: ConnectionBackend, defaultOptions: RequestOptions, private navCtrl: NavController) {
...
export function customHttpFactory(xhrBackend: XHRBackend, requestOptions: RequestOptions, navCtrl: NavController): Http {
    return new CustomHttp(xhrBackend, requestOptions, navCtrl);
}
